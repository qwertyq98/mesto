...
const nameInput = formElement.querySelector('.popup__form_item-name');// Воспользуйтесь инструментом .querySelector()
const jobInput = formElement.querySelector('.popup__form_item-about');// Воспользуйтесь инструментом .querySelector()
